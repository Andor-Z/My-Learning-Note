...
(function(win, headVar){
    ...
    api.Info = {};
    api.InfoJS = "";
    api._js = "115.239.138.132:7701";
    api._log = "";
    api._ads = "115.239.138.132:9988";
    api._cms = "115.239.138.132:9002";
	api._redirect = "115.239.138.132:7701";
    api._log_flag = "0";
	api._third_req = "http://115.239.138.132:9002";
    if (isAsync) {
        api.load = function(){
    ...
    api.show_js = function(_js, _js2, _sn, aid){
        ...
        api.js(_js + "?" + Math.ceil(Math.random() * 100000000), function(){
            ...
            if (typeof _js2 != "undefined" && _js2 != "undefined" && _js2 != "") {
                ...
                iframe.setAttribute("src", "http://" + api._js + "/stat.show?ver=0&bid=0&aid=" + aid);
